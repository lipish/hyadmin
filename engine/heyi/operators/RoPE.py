...
from heyi.models.deepseek_v2 import (
...
# class RotaryEmbedding(OptModule, DeepseekV2RotaryEmbedding):
#     def __init__(
#         self,
#         key: str,
...
# class RotaryEmbeddingV3(OptModule):
#     def __init__(
#         self,
#         key: str,
#         gguf_loader: WeightLoader,
#         config: PretrainedConfig,
...
# class YarnRotaryEmbedding(OptModule, DeepseekV2YarnRotaryEmbedding):
#     def __init__(
#         self,
#         key: str,
#         gguf_loader: WeightLoader,
...
class YarnRotaryEmbeddingV3(nn.Module):
    def __init__(
        self,
        # key: str,
        # gguf_loader: WeightLoader,
